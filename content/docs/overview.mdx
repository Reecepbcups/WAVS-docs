...
The following is a basic overview of a WAVS service. Visit the [How it works section](./how-it-works) for a more in-depth overview of WAVS. Check out the WAVS tutorial to learn how to build a service.
