...
Take a look at the [`PredictionMarketOracleController.sol` file]https://github.com/Lay3rLabs/wavs-demos/blob/558e38be828647c3d539cd1d2c6d96c0eb7f442f/src/PredictionMarketOracleController.sol to get an idea of how the contract is structured.
