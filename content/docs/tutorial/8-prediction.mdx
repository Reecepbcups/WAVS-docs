...
Take a look at the [`PredictionMarketOracleController.sol`](https://github.com/Lay3rLabs/wavs-demos/blob/558e38be828647c3d539cd1d2c6d96c0eb7f442f/src/PredictionMarketOracleController.sol) file to get an idea of how the contract is structured.
...
You can run the prediction market demo locally by following the steps from the [README](https://github.com/Lay3rLabs/wavs-demos/blob/a8d24359391d51bc894afa6e2fbef045bf6ec051/PREDICTION_MARKET_DEMO.md).
