...
The template already contains the necessary files for the oracle example to run. For example, the trigger ([`WavsTrigger.sol`](https://github.com/Lay3rLabs/wavs-foundry-template/blob/6fb281c9382ceefdc8538b7a8e29916c509aafc9/src/contracts/WavsTrigger.sol)) and submission ([`WavsSubmit.sol`](https://github.com/Lay3rLabs/wavs-foundry-template/blob/6fb281c9382ceefdc8538b7a8e29916c509aafc9/src/contracts/WavsSubmit.sol)) contracts can be found in the [`/my-wavs/src/`](https://github.com/Lay3rLabs/wavs-foundry-template/tree/6fb281c9382ceefdc8538b7a8e29916c509aafc9/src) folder.

In [`/eth-price-oracle/src/lib.rs`](https://github.com/Lay3rLabs/wavs-foundry-template/blob/6fb281c9382ceefdc8538b7a8e29916c509aafc9/components/eth-price-oracle/src/lib.rs) you'll find the oracle service component.
