...
3. Run the following command to open your project in VS code:
...
The template already contains the necessary files for the oracle example to run. For example, the trigger ([`WavsTrigger.sol`](https://github.com/Lay3rLabs/wavs-foundry-template/blob/main/src/WavsTrigger.sol)) and submission ([`WavsSubmit.sol`](https://github.com/Lay3rLabs/wavs-foundry-template/blob/main/src/WavsSubmit.sol)) contracts can be found in the [`/my-wavs/src/`](https://github.com/Lay3rLabs/wavs-foundry-template/tree/main/src) folder.

In [`/eth-price-oracle/src/lib.rs`](https://github.com/Lay3rLabs/wavs-foundry-template/blob/main/components/eth-price-oracle/src/lib.rs) you'll find the oracle service component.
