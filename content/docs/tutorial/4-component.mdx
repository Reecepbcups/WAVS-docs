...
The price data is ready to be submitted by operators via the submission contract (also known as the Service Handler), which will verify that the response was sent by an operator before submitting onchain.
