...
This command uses the script located in [`script/Deploy.s.sol`](https://github.com/Lay3rLabs/wavs-foundry-template/blob/fd9d6895e3ebf40373c82c0169c8f93c2553f5a3/script/Trigger.s.sol) to deploy your contracts.
...
This command specifies the event emitted from your trigger contract as the on-chain event that will trigger your service. In the [`Makefile`](https://github.com/Lay3rLabs/wavs-foundry-template/blob/fd9d6895e3ebf40373c82c0169c8f93c2553f5a3/Makefile#L95-L102), you can also see that it specifies the submission contract as the `submit-address`, as well as the filename of your component.

<Callout title="Customize variables" type="info">

Open the [`Makefile`](https://github.com/Lay3rLabs/wavs-foundry-template/blob/fd9d6895e3ebf40373c82c0169c8f93c2553f5a3/Makefile#L9-L22) to view the different variables that you can customize, including the trigger event, the component filename, and the service config.
...
Running this command will execute [`/script/Trigger.s.sol`](https://github.com/Lay3rLabs/wavs-foundry-template/blob/fd9d6895e3ebf40373c82c0169c8f93c2553f5a3/script/Trigger.s.sol) and pass the ID to the trigger contract, starting the following chain of events:
